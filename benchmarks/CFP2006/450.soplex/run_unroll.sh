...
fname="450.soplex"
INPUTFILE="/home/vgogte/spec2006/benchspec/CPU2006/450.soplex/data/test/input/test.mps"
OUTPUTFILE=""
STDOUTFILE="soplex.test.out"
STDERRFILE="soplex.test.err"					   
ARGUMENTS="-m1200 $(basename "$INPUTFILE")"

PATH=$PATH:/home/vgogte/build/Release+Asserts/bin
unroll_factor=$1

cd Output
cp /home/vgogte/spec2006/benchspec/CPU2006/450.soplex/data/test/input/test.mps ./.
...
#clang -std=c++11 -emit-llvm -o timer.bc -c $PASS_HOME/../utils/timerFuncs.cpp || { echo "Failed to emit llvm bc for timers"; exit 1; }
