...
fname="456.hmmer"
INPUTFILE="/home/vgogte/spec2006/benchspec/CPU2006/456.hmmer/data/test/input/bombesin.hmm"
OUTPUTFILE=""
STDOUTFILE="hmmer.test.bombesin.out"
STDERRFILE="hmmer.test.bombesin.err"	
ARGUMENTS=" --fixed 0 --mean 325 --num 45000 --sd 200 --seed 0 $(basename "$INPUTFILE")"
